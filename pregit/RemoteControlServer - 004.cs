...
SetIonCounterState (ActivateIonCounter) is currently disabled
*/
class RemoteControl
{
...
//============================================================================================			
	...
	public static void SetIonCounterState(bool state)
	{
		...
		{	
			Logger.Log (LogLevel.UserInfo,String.Format("cup {0}", col.Mass));
			
			if ((col.CollectorType == IRMSBaseCollectorType.CounterCup) && (col.Mass.HasValue == true))
			{
			    col.Active = state;
			    Logger.Log (LogLevel.UserInfo, "Activate");
			}
		}
